...
> Introduction To Linux: A Hands-On Guide. I recommend this course if you are new to
>
SE: [Unix Tools: Data, Software and Production Engineering](https://www.edx.org/course/unix-tools-data-software-and-production-engineering)
...
3. Make `setup_env.sh` executable: `chmod +x setup_env.sh`
4. Run: `./setup_env.sh`
...
- install modern [developer fonts](nerdfonts.com)
